<template>
  <v-app>
    ...
    <v-app-bar
      app
      flat
      :style="{ backgroundColor: '#EBEBEB', height: '64px', boxShadow: 'none', display: 'flex', alignItems: 'center' }"
      elevation="0"
    >
      <v-toolbar-title
        class="font-weight-bold custom-title"
        style="font-family: 'Inter', sans-serif; font-size: 30px; color: #6E787A; font-weight: 800; line-height: 1.4; padding: 8px 0; display: flex; align-items: center;"
      >
        Trip Odyssey
      </v-toolbar-title>
...
.custom-nav-btn {
  ...
  transition: transform 0.2s, border-color 0.2s, border-width 0.2s, background-color 0.2s;
}
